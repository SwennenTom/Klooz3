        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    partnerImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    partnerLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    partnerDisplayOrder = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    experimentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    experimentImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ...
                    experimentPhotos = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
